...
-- MERCH_PRODUCTS
-- =========================
INSERT IGNORE INTO merch_products (id, name, price, description) VALUES
...
-- MANGA_BOOKS
-- =========================
INSERT IGNORE INTO manga_books (id, author, volume_number, publisher) VALUES
...
-- FIGURES
-- =========================
INSERT IGNORE INTO figures (id, brand, character_name, scale) VALUES
    (11, 'Bandai', 'Goku', '1/8'),
...
-- APPARELS
-- =========================
INSERT IGNORE INTO apparels (id, size, color, type) VALUES
    (21, 'M', 'Black', 'Hoodie'),
    (22, 'L', 'White', 'T-Shirt'),
    (23, 'S', 'Red', 'Hoodie'),
    (24, 'M', 'Gray', 'T-Shirt'),
...
-- CUSTOMERS
-- =========================
INSERT IGNORE INTO customers (id, name, email, user_id) VALUES
    (1, 'Manga Fan', 'mangafan@example.com', 2);

-- =========================
-- ORDERS
-- =========================
INSERT IGNORE INTO orders (id, date, total, status, customer_id) VALUES
    (1, NOW(), 49.97, 'PENDING', 1);

-- =========================
-- ORDER_PRODUCTS
-- =========================
INSERT IGNORE INTO order_products (id, quantity, subtotal, order_id, merch_product_id) VALUES
    (1, 2, 19.98, 1, 1),
    (2, 1, 29.99, 1, 11);
